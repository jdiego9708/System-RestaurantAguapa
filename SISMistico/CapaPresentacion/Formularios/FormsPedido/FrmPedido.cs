    ...
    public partial class FrmPedido : Form
    {
                                        ...
                                        out DataTable dtBebidas))
                {
                    ...
                    if (rpta.Equals("OK"))
                    {
                        ...
                        if (this.chkPrintComandas.Checked)
                        {
                            ...
                            {
                                this.frmComandas.ObtenerReporte("Aguapanelas de mi tierra | Bebidas");
                            ...
                            {
                                this.frmComandas.ObtenerReporte("Aguapanelas de mi tierra | Platos");
        ...
        private void FrmPedido_Load(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.OK)
            {
                ...
                this.frmComandas.ObtenerReporte("Aguapanelas de mi tierra comanda");
